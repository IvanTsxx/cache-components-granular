...
export const docs = await create.docs(
  ...
  {},
  {
    "en/concepts.mdx": __fd_glob_0,
    "en/implementation.mdx": __fd_glob_1,
    "en/index.mdx": __fd_glob_2,
    "en/revalidation.mdx": __fd_glob_3,
    "en/shared-promise.mdx": __fd_glob_4,
    "es/concepts.mdx": __fd_glob_5,
    "es/implementation.mdx": __fd_glob_6,
    "es/index.mdx": __fd_glob_7,
    "es/revalidation.mdx": __fd_glob_8,
    "es/shared-promise.mdx": __fd_glob_9,
  }
);
