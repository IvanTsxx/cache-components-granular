...
<Callout type="info">
En **Build Time**, el texto y precio ejecutan sus queries de Base de Datos para guardarse en el prerender. El stock se ignora. <br/>
En **Request Time**, el stock ejecuta su query mientas el usuario ya está viendo el contenido prerenderizado (static shell).
</Callout>
