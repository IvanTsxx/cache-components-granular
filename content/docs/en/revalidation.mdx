...
<Callout type="success">
  **Rule of thumb:** Use tags for granular control. Only use `revalidatePath`
  when you want to literally invalidate a whole page.
</Callout>
...
<Callout type="warning">
  **Performance Tip:** Too many simultaneous revalidations can spike load. Use
  deliberately.
</Callout>
